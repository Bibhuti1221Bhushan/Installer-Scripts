            ...
            delegate: ItemDelegate {
                ...
                contentItem: Item {
                    Image {
                        ...
                        source: index == 0 ? Qt.resolvedUrl("../icons/sleep.png") : (index == 1 ? Qt.resolvedUrl("../icons/restart.png") : Qt.resolvedUrl("../icons/power.png"))
